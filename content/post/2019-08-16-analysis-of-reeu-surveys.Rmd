...
```{r pre-survey, results='hide', echo=FALSE, message=FALSE, cache=TRUE}
...
```{r pre-survey-split, echo=FALSE, cache=TRUE}
...
```{r high-questions, echo=FALSE, message=FALSE, cache=TRUE}
...
```{r wc-q28, echo=FALSE, message=FALSE, cache=TRUE}
...
```{r wc-q29, echo=FALSE, message=FALSE, cache=TRUE}
...
```{r wc-q30, echo=FALSE, message=FALSE, cache=TRUE}
...
```{r post-survey, results='hide', echo=FALSE, message=FALSE, cache=TRUE}
# post-survey data
post_reeu_data <- REEU %>% 
	gs_read(ws = 2) %>% 
	dplyr::select(-question_prefix, -question_text)
...
```{r q1to19-text, echo=FALSE, message=FALSE, cache=TRUE}
get_questions <- function(rated_qs, result_lev){
...
```{r q20-25, echo=FALSE, cache=TRUE}
...
```{r q20to25-text, echo=FALSE, message=FALSE, cache=TRUE}
...
```{r q26-29, echo=FALSE, cache=TRUE}
...
```{r q26to29-text, echo=FALSE, message=FALSE, cache=TRUE}
...
```{r q30-33, echo=FALSE, cache=TRUE}
...
```{r q30to33-text, echo=FALSE, message=FALSE, cache=TRUE}
...
```{r q34-38, echo=FALSE, cache=TRUE}
...
```{r q34to38-text, echo=FALSE, message=FALSE, cache=TRUE}
...
```{r textq1, echo=FALSE, message=FALSE, cache=TRUE}
# text responses
...
```{r textq2, echo=FALSE, message=FALSE, cache=TRUE}
...
```{r mentor-qs, echo=FALSE, message=FALSE, cache=TRUE}
questions <- mentor %>% 
	slice(1) %>% 
...
```{r pre-post, echo=FALSE, message=FALSE, cache=TRUE}
